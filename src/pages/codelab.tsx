  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://edwardchew.vercel.app/codelab"/>
        <meta property="og:image" content="https://edwardchew.vercel.app/images/Home/PrimaryProjects/CodeLabCommunity.png"/>
      </Head>
      ...
      <div className={` ${projStyles["project-page"]} ${styles["codelab"]} `}>
        ...
        <section className="row justify-content-center">
          <div className="col-md-12">
            ...
            <p className="small-body">
              As of Spring 2023, CodeLab has built 32 projects, worked with 15 industry clients, and had 180 members and alumni across our 6 project terms. Learn more about the organization on our <Link className="small-body" href="https://codelabdavis.com/" target="blank_">website</Link>. (Our website was also a project I designed and led the development team on!)
            </p>
            <p className="small-body">
        ...
        <section className="row">
          <div className="col-md-12">
            ...
            <p className="small-body">
              After serving two years as the Vice President of External, I became the President of CodeLab for the 2022-2023 academic year. And wow, leading a team was a challenge. Prior to moving into the position, I anticipated I would be focused on giving high-level direction on where to steer the organization. Instead, my biggest challenges this year were from handling <span className="italic">people</span>, not the organization. I found I needed to drive intrinsic motivation in the team, balance everyone’s interests, gain commitment to initiatives, and generally work to improve morale, among other things.
            </p>
            <p className="small-body">
              To read about the changes the organization saw in my year as president, read our <Link className="small-body" href="https://medium.com/@codelabdavis/codelab-2022-2023-year-in-review-251bb2ee31df" target="blank_">Medium article</Link>.
            </p>
          </div>
          <div className="col-md-4">
        ...
        <section className="row justify-content-center">
          <div className="col-md-12">
            ...
            <ol className="small-body">
              <li><span className="demi">I met a lot of amazing people.</span> I met a lot of amazing people. The board members were the most motivated team I’ve ever been a part of, and I’m really glad to have forged new professional connections and close friendships.</li>
              <li><span className="demi">I explored career paths.</span> I’m a computer science major, so software engineering is the obvious path to go. But through CodeLab, I’ve also had opportunities to explore UX design, graphic design, project management, product management, marketing, and more.</li>
              <li><span className="demi">I’ve learned strategies to build an enduring organization.</span> Over time, I’ve learned the value of systems thinking. To be able to build upon the board’s previous work, we needed to create structures to systematize every part of the club. And further, we needed to test and iterate on every one of these systems. “Building systems” is a vague phrase, but this mindset helped us grow effectively.</li>
              <li><span className="demi">I’ve learned the role of a manager and a leader.</span> My role as president wasn’t a directing and planning role, but a people and managing role. I had to ask myself a lot of questions about the team, like: How can we make members feel a stake in the organization? What are board members’ motivations? What problems might I not be seeing?</li>
            </ol>
            <p className="small-body">
          ...
          <div className="col-md-6">
            <img src={Reflections1.src} alt="CodeLab banquet, where I said my goodbyes"/>
            <h5 className={projStyles["caption"]}>CodeLab banquet, where I said my goodbyes</h5>
          </div>
        </section>
