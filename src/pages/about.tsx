  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:image"
          content="https://www.edwardchew.me/images/About/Edward.jpg"
        />
      </Head>

      <div
        className={` ${styles["rellax"]} rellax ${styles["lines1"]} `}
        ref={rellaxRef}
      >
        <img src={Curve4.src} alt="Background Curve" />
      </div>
      <div
        className={` ${styles["rellax"]} rellax ${styles["lines2"]} `}
        ref={rellaxRef}
      >
        <img src={Curve5.src} alt="Background Curve" />
      </div>
      ...
      <div className={styles["about"]}>
        <section className={styles["summary"]}>
          <div className="row">
            ...
            <div className={` ${styles["right"]} col-md-7 `}>
              <h1>I’m Edward.</h1>
              <p>
                I’m a frontend-leaning full-stack engineer currently building
                enterprise LLM solutions at{" "}
                <Link
                  className="link"
                  href="https://distyl.ai/"
                  target="_blank"
                >
                  Distyl
                </Link>
                . I’m heavily focused on user impact and have worked in the UX
                and product space to complement my development skills. I hope to
                apply my breadth of skills to better engage users with complex
                technologies, especially in emerging domains like generative AI.
              </p>
              <p>
                When I’m not coding, I love exploring new places. Since the
                beginning of the pandemic, I’ve biked hundreds (if not
                thousands) of miles around Davis and the Bay Area. Other times,
                I explore on foot, seeing what hill offers the best view in San
                Francisco. I express my creativity on physical mediums as well.
                In my apartment, you’ll find sticky notes and posters on the
                walls adorned with Sharpie doodles.
              </p>
              <Link
                className="link"
        ...
        <section className={styles["snapshots"]}>
          ...
          <div
            className={` ${styles["full-grid"]} ${utils["gutter25-row"]} row no-gutters `}
          >
            <div
              className={` ${utils["gutter25-col"]} ${styles["highlight"]} col-md-3 `}
            >
              <img src={LifeA.src} alt="Happy times!" />
            </div>
            <div
              className={` ${utils["gutter25-col"]} ${styles["highlight-text"]} col-md-3 `}
            >
              <div className={styles["front-rectangle"]}></div>
              <div className={styles["back-rectangle"]}></div>
              <p>
                <b className="bold">HackDavis 2020,</b>
                <br /> my first ever <br />
                hackathon
              </p>
            </div>
            <div className={` ${utils["gutter25-col"]} col-md-3 `}>
              <img src={Life1.src} alt="Happy times!" />
            </div>
            <div className={` ${utils["gutter25-col"]} col-md-3 `}>
              <img src={Life2.src} alt="Happy times!" />
            </div>
            <div className={` ${utils["gutter25-col"]} col-md-3 `}>
              <img src={Life3.src} alt="Happy times!" />
            </div>
            <div className={` ${utils["gutter25-col"]} col-md-3 `}>
              <img src={Life4.src} alt="Happy times!" />
            </div>
            <div className={` ${utils["gutter25-col"]} col-md-3 `}>
              <img src={Life5.src} alt="Happy times!" />
            </div>
            <div className={` ${utils["gutter25-col"]} col-md-3 `}>
              <img src={Life6.src} alt="Happy times!" />
            </div>
            <div className={` ${utils["gutter25-col"]} col-md-3 `}>
              <img src={Life7.src} alt="Happy times!" />
            </div>
            <div className={` ${utils["gutter25-col"]} col-md-3 `}>
              <img src={Life8.src} alt="Happy times!" />
            </div>
            <div
              className={` ${utils["gutter25-col"]} ${styles["highlight"]} col-md-3 `}
            >
              <img src={LifeB.src} alt="Happy times!" />
            </div>
            <div
              className={` ${utils["gutter25-col"]} ${styles["highlight-text"]} col-md-3 `}
            >
